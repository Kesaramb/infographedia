 ...
 * Shared by schema validation and map renderers.
 */
const ALPHA2_TO_NUMERIC: Record<string, string> = {
  ...
  SZ: '748', ET: '231', FJ: '242', FI: '246', FR: '250',
  GA: '266', GM: '270', GE: '268', DE: '276', GH: '288',
  GR: '300', GT: '320', GN: '324', GW: '624', GY: '328',
  HT: '332', HN: '340', HU: '348', IS: '352', IN: '356',
  ID: '360', IR: '364', IQ: '368', IE: '372', IL: '376',
  IT: '380', JM: '388', JP: '392', JO: '400', KZ: '398',
  KE: '404', KI: '296', KP: '408', KR: '410', KW: '414',
  KG: '417', LA: '418', LV: '428', LB: '422', LS: '426',
  LR: '430', LY: '434', LT: '440', LU: '442', MG: '450',
  MW: '454', MY: '458', MV: '462', ML: '466', MT: '470',
  MR: '478', MU: '480', MX: '484', MD: '498', MN: '496',
  ME: '499', MA: '504', MZ: '508', MM: '104', NA: '516',
  NP: '524', NL: '528', NZ: '554', NI: '558', NE: '562',
  NG: '566', MK: '807', NO: '578', OM: '512', PK: '586',
  ...
  UZ: '860', VU: '548', VE: '862', VN: '704', YE: '887',
  ZM: '894', ZW: '716',
}
...
export function isValidCountryCode(alpha2: string): boolean {
  return Boolean(getNumericCode(alpha2))
}
